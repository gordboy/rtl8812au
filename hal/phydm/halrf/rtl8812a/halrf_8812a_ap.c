...
)
{
	if (method == TXAGC) {
		...
		ODM_RT_TRACE(p_dm, ODM_COMP_TX_PWR_TRACK, ODM_DBG_LOUD, ("odm_TxPwrTrackSetPwr88E CH=%d\n", *(p_dm->p_channel)));
#if (DM_ODM_SUPPORT_TYPE & (ODM_WIN | ODM_CE))

		pwr = phy_query_bb_reg(adapter, REG_TX_AGC_A_RATE18_06, 0xFF);
		pwr += (p_dm->bb_swing_idx_cck - p_dm->bb_swing_idx_cck_base);
		...
		pwr = phy_query_bb_reg(adapter, REG_TX_AGC_A_RATE18_06, 0xFF);
		pwr += (p_dm->bb_swing_idx_ofdm[RF_PATH_A] - p_dm->bb_swing_idx_ofdm_base);
		...
		if (rf_path == RF_PATH_A)
			odm_set_bb_reg(p_dm, REG_A_TX_SCALE_JAGUAR, MASKDWORD, p_dm->bb_swing_idx_ofdm[RF_PATH_A]);
		else if (rf_path == RF_PATH_B)
			odm_set_bb_reg(p_dm, REG_B_TX_SCALE_JAGUAR, MASKDWORD, p_dm->bb_swing_idx_ofdm[RF_PATH_B]);
	} else
		return;
...
)
{
	...
	odm_set_bb_reg(p_dm, REG_RX_IQK_TONE_A, MASKDWORD, 0x30008c1c);
	odm_set_bb_reg(p_dm, REG_TX_IQK_PI_A, MASKDWORD, 0x8214032a);
	...
	ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("0xe94 = 0x%x\n", reg_e94));
	reg_e9c = odm_get_bb_reg(p_dm, REG_TX_POWER_AFTER_IQK_A, MASKDWORD);
	ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("0xe9c = 0x%x\n", reg_e9c));
	reg_ea4 = odm_get_bb_reg(p_dm, REG_RX_POWER_BEFORE_IQK_A_2, MASKDWORD);
	ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("0xea4 = 0x%x\n", reg_ea4));
...
)
{
	...
	odm_set_bb_reg(p_dm, REG_FPGA0_IQK, 0xffffff00, 0);
	odm_set_rf_reg(p_dm, RF_PATH_A, RF_WE_LUT, RFREGOFFSETMASK, 0x800a0);
	odm_set_rf_reg(p_dm, RF_PATH_A, RF_RCK_OS, RFREGOFFSETMASK, 0x30000);
	odm_set_rf_reg(p_dm, RF_PATH_A, RF_TXPA_G1, RFREGOFFSETMASK, 0x0000f);
	odm_set_rf_reg(p_dm, RF_PATH_A, RF_TXPA_G2, RFREGOFFSETMASK, 0xf117B);
	odm_set_bb_reg(p_dm, REG_FPGA0_IQK, 0xffffff00, 0x808000);

	/* IQK setting */
	odm_set_bb_reg(p_dm, REG_TX_IQK, MASKDWORD, 0x01007c00);
	odm_set_bb_reg(p_dm, REG_RX_IQK, MASKDWORD, 0x81004800);

	/* path-A IQK setting */
	odm_set_bb_reg(p_dm, REG_TX_IQK_TONE_A, MASKDWORD, 0x10008c1c);
	odm_set_bb_reg(p_dm, REG_RX_IQK_TONE_A, MASKDWORD, 0x30008c1c);
	odm_set_bb_reg(p_dm, REG_TX_IQK_PI_A, MASKDWORD, 0x82160804);
	odm_set_bb_reg(p_dm, REG_RX_IQK_PI_A, MASKDWORD, 0x28160000);
	...
	odm_set_rf_reg(p_dm, RF_PATH_A, RF_RCK_OS, RFREGOFFSETMASK, 0x30000);
	odm_set_rf_reg(p_dm, RF_PATH_A, RF_TXPA_G1, RFREGOFFSETMASK, 0x0000f);
	odm_set_rf_reg(p_dm, RF_PATH_A, RF_TXPA_G2, RFREGOFFSETMASK, 0xf7ffa);
	odm_set_bb_reg(p_dm, REG_FPGA0_IQK, 0xffffff00, 0x808000);
	...
	/* path-A IQK setting */
	odm_set_bb_reg(p_dm, REG_TX_IQK_TONE_A, MASKDWORD, 0x30008c1c);
	odm_set_bb_reg(p_dm, REG_RX_IQK_TONE_A, MASKDWORD, 0x10008c1c);
	odm_set_bb_reg(p_dm, REG_TX_IQK_PI_A, MASKDWORD, 0x82160c05);
	odm_set_bb_reg(p_dm, REG_RX_IQK_PI_A, MASKDWORD, 0x28160c05);
...
)
{
	...
	ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("One shot, path A LOK & IQK!\n"));
	odm_set_bb_reg(p_dm, REG_IQK_AGC_CONT, MASKDWORD, 0x00000002);
	odm_set_bb_reg(p_dm, REG_IQK_AGC_CONT, MASKDWORD, 0x00000000);
	...
	reg_eac = odm_get_bb_reg(p_dm, REG_RX_POWER_AFTER_IQK_A_2, MASKDWORD);
	ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("0xeac = 0x%x\n", reg_eac));
	reg_eb4 = odm_get_bb_reg(p_dm, REG_TX_POWER_BEFORE_IQK_B, MASKDWORD);
	ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("0xeb4 = 0x%x\n", reg_eb4));
	reg_ebc = odm_get_bb_reg(p_dm, REG_TX_POWER_AFTER_IQK_B, MASKDWORD);
	ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("0xebc = 0x%x\n", reg_ebc));
	reg_ec4 = odm_get_bb_reg(p_dm, REG_RX_POWER_BEFORE_IQK_B_2, MASKDWORD);
	ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("0xec4 = 0x%x\n", reg_ec4));
	reg_ecc = odm_get_bb_reg(p_dm, REG_RX_POWER_AFTER_IQK_B_2, MASKDWORD);
	ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("0xecc = 0x%x\n", reg_ecc));
...
)
{
	...
	if (final_candidate == 0xFF)
		...
		if (is_tx_only) {
			ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("_phy_path_a_fill_iqk_matrix_8812a only Tx OK\n"));
			return;
		}
...
)
{
	...
	if (false == is2T) {
		path_on = 0x0bdb25a0;
		odm_set_bb_reg(p_dm, adda_reg[0], MASKDWORD, 0x0b1b25a0);
	} else
...
)
{
	...
	odm_set_bb_reg(p_dm, REG_FPGA0_IQK, 0xffffff00, 0x0);
...
)
{
	...
	ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("===> IQK:phy_simularity_compare_8812a c1 %d c2 %d!!!\n", c1, c2));
	...
	for (i = 0; i < bound; i++) {
		...
		if (diff > MAX_TOLERANCE) {
			ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("IQK:phy_simularity_compare_8812a differnece overflow index %d compare1 0x%x compare2 0x%x!!!\n",  i, (u32)result[c1][i], (u32)result[c2][i]));
	...
	ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("IQK:phy_simularity_compare_8812a simularity_bit_map   %d !!!\n", simularity_bit_map));
...
)
{
	...
	case RF_PATH_A:
	{
		...
		odm_write_4byte(p_dm, 0xc90, 0x00000080);
		odm_write_4byte(p_dm, 0xcc4, 0x20040000);
	...
	{
		odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1); /* [31] = 1 --> Page C1 */
		odm_write_4byte(p_dm, 0xe90, 0x00000080);
		odm_write_4byte(p_dm, 0xec4, 0x20040000);
...
)
{
	...
	odm_set_bb_reg(p_dm, 0x808, BIT(28), 0x0);	/*		CCK Off */
...
)
{
	...
	p_dm->priv->pshare->IQK_total_cnt++;

	ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("band_width = %d ext_pa = %d pBand = %d\n", *p_dm->p_band_width, p_dm->ext_pa, *p_dm->p_band_type));

	if (*p_dm->p_band_width == 2)
		VDF_enable = true;

	temp_reg65 = odm_get_rf_reg(p_dm, (enum rf_path)path, 0x65, MASKDWORD);
	...
	case RF_PATH_A:
		...
		/*Port 1 DAC/ADC off*/
		odm_write_4byte(p_dm, 0xe60, 0x00000000);
		odm_write_4byte(p_dm, 0xe64, 0x00000000);

		odm_write_4byte(p_dm, 0xc68, 0x19791979);
		odm_set_bb_reg(p_dm, 0xc00, 0xf, 0x4);

		/*DAC/ADC sampling rate (160 MHz)*/
		odm_set_bb_reg(p_dm, 0xc5c, BIT(26) | BIT(25) | BIT(24), 0x7);

		odm_set_bb_reg(p_dm, 0xcb0, 0x00ff0000, 0x77);
		odm_set_bb_reg(p_dm, 0xcb4, 0x03000000, 0x0);
		break;
	case RF_PATH_B:
		odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
		/*Port 0 DAC/ADC off*/
		odm_write_4byte(p_dm, 0xc60, 0x00000000);
		odm_write_4byte(p_dm, 0xc64, 0x00000000);
		...
		odm_set_bb_reg(p_dm, 0xe00, 0xf, 0x4);

		/*DAC/ADC sampling rate (160 MHz)*/
		odm_set_bb_reg(p_dm, 0xe5c, BIT(26) | BIT(25) | BIT(24), 0x7);
		odm_set_bb_reg(p_dm, 0xeb0, 0x00ff0000, 0x77);
		odm_set_bb_reg(p_dm, 0xeb4, 0x03000000, 0x0);
		break;
	default:
		break;
	}
	...
	while (cal < cal_num) {
		...
		case RF_PATH_A:
		{
			/*======pathA TX IQK ======*/
			odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
			odm_set_rf_reg(p_dm, (enum rf_path)path, 0xef, RFREGOFFSETMASK, 0x80002);
			odm_set_rf_reg(p_dm, (enum rf_path)path, 0x30, RFREGOFFSETMASK, 0x20000);
			odm_set_rf_reg(p_dm, (enum rf_path)path, 0x31, RFREGOFFSETMASK, 0x3fffd);
			odm_set_rf_reg(p_dm, (enum rf_path)path, 0x32, RFREGOFFSETMASK, 0xfe83f);
			odm_set_rf_reg(p_dm, (enum rf_path)path, 0x65, RFREGOFFSETMASK, 0x931d5);
			odm_set_rf_reg(p_dm, (enum rf_path)path, 0x8f, RFREGOFFSETMASK, 0x8a001);
			...
			if (VDF_enable == 1) {
				/*====== pathA VDF TX IQK ======*/
				ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("TXVDF Start\n"));
				for (k = 0; k <= 2; k++) {
					switch (k) {
					case 0:
						odm_write_4byte(p_dm, 0xc80, 0x18008c38);/*TX_Tone_idx[9:0], TxK_Mask[29] TX_Tone = 16*/
						odm_write_4byte(p_dm, 0xc84, 0x38008c38);/*RX_Tone_idx[9:0], RxK_Mask[29]*/
						odm_write_4byte(p_dm, 0x984, 0x00462910);/*[0]:AGC_en, [15]:idac_K_Mask*/
						odm_set_bb_reg(p_dm, 0xce8, BIT(31), 0x0);
						break;
					case 1:
						odm_set_bb_reg(p_dm, 0xc80, BIT(28), 0x0);
						odm_set_bb_reg(p_dm, 0xc84, BIT(28), 0x0);
						odm_write_4byte(p_dm, 0x984, 0x0046a910);/*[0]:AGC_en, [15]:idac_K_Mask*/
						break;
					case 2:
						ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("VDF_Y[1] = %x;;;VDF_Y[0] = %x\n", VDF_Y[1] >> 21 & 0x00007ff, VDF_Y[0] >> 21 & 0x00007ff));
						ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("VDF_X[1] = %x;;;VDF_X[0] = %x\n", VDF_X[1] >> 21 & 0x00007ff, VDF_X[0] >> 21 & 0x00007ff));
						tx_dt[cal] = (VDF_Y[1] >> 20) - (VDF_Y[0] >> 20);
						ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("tx_dt = %d\n", tx_dt[cal]));
						tx_dt[cal] = ((16 * tx_dt[cal]) * 10000 / 15708);
						tx_dt[cal] = (tx_dt[cal] >> 1) + (tx_dt[cal] & BIT(0));
						odm_write_4byte(p_dm, 0xc80, 0x18008c20);
						odm_write_4byte(p_dm, 0xc84, 0x38008c20);
						odm_set_bb_reg(p_dm, 0xce8, BIT(31), 0x1);
						odm_set_bb_reg(p_dm, 0xce8, 0x3fff0000, tx_dt[cal] & 0x00003fff);
						break;
					default:
						break;
					}

					odm_write_4byte(p_dm, 0xcb8, 0x00100000);/*cb8[20] SI/PI*/
					cal_retry = 0;
					while (1) {
						/*one shot*/
						...
						delay_count = 0;
						while (1) {
							IQK_ready = odm_get_bb_reg(p_dm, 0xd00, BIT(10));
						...
						if (delay_count < 20) {
							...
							TX_fail = odm_get_bb_reg(p_dm, 0xd00, BIT(12));
							if (~TX_fail) {
								odm_write_4byte(p_dm, 0xcb8, 0x02000000);
								VDF_X[k] = odm_get_bb_reg(p_dm, 0xd00, 0x07ff0000) << 21;
								odm_write_4byte(p_dm, 0xcb8, 0x04000000);
								VDF_Y[k] = odm_get_bb_reg(p_dm, 0xd00, 0x07ff0000) << 21;
								TX0IQKOK = true;
								break;
							} else {
								TX0IQKOK = false;
				...
				ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("TXA_VDF_cal_retry = %d\n", cal_retry));
				TX_X0[cal] = VDF_X[k - 1];
				TX_Y0[cal] = VDF_Y[k - 1];
			} else {
				...
				while (1) {
					...
					if (delay_count < 20) {
						...
						if (~TX_fail) {
							odm_write_4byte(p_dm, 0xcb8, 0x02000000);
							TX_X0[cal] = odm_get_bb_reg(p_dm, 0xd00, 0x07ff0000) << 21;
							odm_write_4byte(p_dm, 0xcb8, 0x04000000);
							TX_Y0[cal] = odm_get_bb_reg(p_dm, 0xd00, 0x07ff0000) << 21;
							TX0IQKOK = true;
#if 0
			...
			odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
			odm_set_rf_reg(p_dm, (enum rf_path)path, 0x58, 0x7fe00, odm_get_rf_reg(p_dm, (enum rf_path)path, 0x8, 0xffc00));
			odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);
			if (TX0IQKOK == false)
				break;
			...
			/*======pathA VDF RX IQK ======*/
			if (VDF_enable == 1) {
				odm_set_bb_reg(p_dm, 0xce8, BIT(31), 0x0);/*TX VDF Disable*/
				ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("RXVDF Start\n"));

				odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
				odm_set_rf_reg(p_dm, (enum rf_path)path, 0xef, RFREGOFFSETMASK, 0x80000);
				odm_set_rf_reg(p_dm, (enum rf_path)path, 0x30, RFREGOFFSETMASK, 0x30000);
				odm_set_rf_reg(p_dm, (enum rf_path)path, 0x31, RFREGOFFSETMASK, 0x3f7ff);
				odm_set_rf_reg(p_dm, (enum rf_path)path, 0x32, RFREGOFFSETMASK, 0xfe7bf);
				odm_set_rf_reg(p_dm, (enum rf_path)path, 0x8f, RFREGOFFSETMASK, 0x88001);
				odm_set_rf_reg(p_dm, (enum rf_path)path, 0x65, RFREGOFFSETMASK, 0x931d0);
				...
				odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);
				odm_write_4byte(p_dm, 0xc88, 0x02140119);
				odm_write_4byte(p_dm, 0xc8c, 0x28161420);

				for (k = 0; k <= 2; k++) {
					odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
					odm_set_bb_reg(p_dm, 0x978, 0x03FF8000, (VDF_X[k]) >> 21 & 0x000007ff);
					odm_set_bb_reg(p_dm, 0x978, 0x000007FF, (VDF_Y[k]) >> 21 & 0x000007ff);

					odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);
					switch (k) {
					case 0:
						odm_write_4byte(p_dm, 0xc80, 0x38008c38);/*TX_Tone_idx[9:0], TxK_Mask[29] TX_Tone = 16*/
						odm_write_4byte(p_dm, 0xc84, 0x18008c38);/*RX_Tone_idx[9:0], RxK_Mask[29]*/
						odm_set_bb_reg(p_dm, 0xce8, BIT(30), 0x0);
						break;
					case 1:
						odm_write_4byte(p_dm, 0xc80, 0x28008c38);
						odm_write_4byte(p_dm, 0xc84, 0x08008c38);
						break;
					case 2:
						ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("VDF_Y[1] = %x;;;VDF_Y[0] = %x\n", VDF_Y[1] >> 21 & 0x00007ff, VDF_Y[0] >> 21 & 0x00007ff));
						ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("VDF_X[1] = %x;;;VDF_X[0] = %x\n", VDF_X[1] >> 21 & 0x00007ff, VDF_X[0] >> 21 & 0x00007ff));
						rx_dt[cal] = (VDF_Y[1] >> 20) - (VDF_Y[0] >> 20);
						ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("rx_dt = %d\n", rx_dt[cal]));
						rx_dt[cal] = ((16 * rx_dt[cal]) * 10000 / 13823);
						rx_dt[cal] = (rx_dt[cal] >> 1) + (rx_dt[cal] & BIT(0));
						odm_write_4byte(p_dm, 0xc80, 0x38008c20);
						odm_write_4byte(p_dm, 0xc84, 0x18008c20);
						odm_set_bb_reg(p_dm, 0xce8, 0x00003fff, rx_dt[cal] & 0x00003fff);
						break;
					default:
						break;
					}
					...
					if (k == 2)
						odm_set_bb_reg(p_dm, 0xce8, BIT(30), 0x1);  /*RX VDF Enable*/

					odm_write_4byte(p_dm, 0xcb8, 0x00100000);/*cb8[20] N SI/PI*/
					cal_retry = 0;
					while (1) {
						/*one shot*/
						odm_write_4byte(p_dm, 0x980, 0xfa000000);
						...
						odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
						ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("==== A VDF: path A RF0 = 0x%x ====\n",
							odm_get_rf_reg(p_dm, (enum rf_path)0, 0x0, RFREGOFFSETMASK)));
						ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("==== A VDF: path B RF0 = 0x%x ====\n",
							odm_get_rf_reg(p_dm, (enum rf_path)1, 0x0, RFREGOFFSETMASK)));
						odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);

						if (delay_count < 20) {
							/*============pathA VDF RXIQK Check==============*/
							RX_fail = odm_get_bb_reg(p_dm, 0xd00, BIT(11));
							if (RX_fail == 0) {
								...
								odm_set_bb_reg(p_dm, 0xc10, 0x000003ff, 0x200 >> 1);
								odm_set_bb_reg(p_dm, 0xc10, 0x03ff0000, 0x0 >> 1);
								RX0IQKOK = false;
								cal_retry++;
								if (cal_retry == 10)
									break;
				...
				ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("RXA_VDF_cal_retry = %d\n", cal_retry));
				RX_X0[cal] = VDF_X[k - 1] ;
				RX_Y0[cal] = VDF_Y[k - 1];
				odm_set_bb_reg(p_dm, 0xce8, BIT(31), 0x1);    /*TX VDF Enable*/
			} else {
				/*====== pathA RX IQK ======*/
				odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
				odm_set_rf_reg(p_dm, (enum rf_path)path, 0xef, RFREGOFFSETMASK, 0x80000);
				...
				odm_set_rf_reg(p_dm, (enum rf_path)path, 0x65, RFREGOFFSETMASK, 0x931d0);
				odm_set_rf_reg(p_dm, (enum rf_path)path, 0xef, RFREGOFFSETMASK, 0x00000);
				odm_set_bb_reg(p_dm, 0x978, 0x03FF8000, (TX_X0[cal]) >> 21 & 0x000007ff);
				odm_set_bb_reg(p_dm, 0x978, 0x000007FF, (TX_Y0[cal]) >> 21 & 0x000007ff);
				odm_set_bb_reg(p_dm, 0x978, BIT(31), 0x1);
				odm_set_bb_reg(p_dm, 0x97c, BIT(31), 0x0);
				odm_write_4byte(p_dm, 0x90c, 0x00008000);
				odm_write_4byte(p_dm, 0x984, 0x0046a911);
				...
				odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);
				odm_write_4byte(p_dm, 0xc80, 0x38008c10);
				odm_write_4byte(p_dm, 0xc84, 0x18008c10);
				odm_write_4byte(p_dm, 0xc88, 0x02140119);
				odm_write_4byte(p_dm, 0xc8c, 0x28161420);
				odm_write_4byte(p_dm, 0xcb8, 0x00100000);
				cal_retry = 0;
				while (1) {
					...
					odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
					ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("==== A: path A RF0 = 0x%x ====\n",
						odm_get_rf_reg(p_dm, (enum rf_path)0, 0x0, RFREGOFFSETMASK)));
					ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("==== A: path B RF0 = 0x%x ====\n",
						odm_get_rf_reg(p_dm, (enum rf_path)1, 0x0, RFREGOFFSETMASK)));
					odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);
					...
					if (delay_count < 20) {
						...
						if (RX_fail == 0) {
							odm_write_4byte(p_dm, 0xcb8, 0x06000000);
							RX_X0[cal] = odm_get_bb_reg(p_dm, 0xd00, 0x07ff0000) << 21;
							odm_write_4byte(p_dm, 0xcb8, 0x08000000);
							RX_Y0[cal] = odm_get_bb_reg(p_dm, 0xd00, 0x07ff0000) << 21;
							RX0IQKOK = true;
#if 0
							...
							reg2 = odm_get_bb_reg(p_dm, 0xd00, 0x0000001f);
							image_power = (reg2 << 32) + reg1;
							ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("Before PW = %d\n", image_power));
							odm_write_4byte(p_dm, 0xcb8, 0x07000000);
							reg1 = odm_get_bb_reg(p_dm, 0xd00, 0xffffffff);
							odm_write_4byte(p_dm, 0xcb8, 0x08000000);
							reg2 = odm_get_bb_reg(p_dm, 0xd00, 0x0000001f);
							image_power = (reg2 << 32) + reg1;
							ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("After PW = %d\n", image_power));
#endif
							break;
						} else {
							odm_set_bb_reg(p_dm, 0xc10, 0x000003ff, 0x200 >> 1);
		...
		case RF_PATH_B:
		{
			...
			if (VDF_enable == 1) {
				...
				for (k = 0; k <= 2; k++) {
					...
					case 0:
						/*one shot*/
						odm_write_4byte(p_dm, 0xe80, 0x18008c38);/*TX_Tone_idx[9:0], TxK_Mask[29] TX_Tone = 16*/
						odm_write_4byte(p_dm, 0xe84, 0x38008c38);/*RX_Tone_idx[9:0], RxK_Mask[29]*/
						odm_write_4byte(p_dm, 0x984, 0x00462910);
						odm_set_bb_reg(p_dm, 0xee8, BIT(31), 0x0);
						break;
					case 1:
						odm_set_bb_reg(p_dm, 0xe80, BIT(28), 0x0);
						odm_set_bb_reg(p_dm, 0xe84, BIT(28), 0x0);
						odm_write_4byte(p_dm, 0x984, 0x0046a910);
						odm_set_bb_reg(p_dm, 0xee8, BIT(31), 0x0);
						break;
					case 2:
						ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("VDF_Y[1] = %x;;;VDF_Y[0] = %x\n", VDF_Y[1] >> 21 & 0x00007ff, VDF_Y[0] >> 21 & 0x00007ff));
						...
						tx_dt[cal] = ((16 * tx_dt[cal]) * 10000 / 15708);
						tx_dt[cal] = (tx_dt[cal] >> 1) + (tx_dt[cal] & BIT(0));
						odm_write_4byte(p_dm, 0xe80, 0x18008c20);
						odm_write_4byte(p_dm, 0xe84, 0x38008c20);
						odm_set_bb_reg(p_dm, 0xee8, BIT(31), 0x1);
						odm_set_bb_reg(p_dm, 0xee8, 0x3fff0000, tx_dt[cal] & 0x00003fff);
						break;
					default:
						break;
					}

					odm_write_4byte(p_dm, 0xeb8, 0x00100000);
					cal_retry = 0;
					while (1) {
						/*one shot*/
						odm_write_4byte(p_dm, 0x980, 0xfa000000);
						...
						delay_count = 0;
						while (1) {
							IQK_ready = odm_get_bb_reg(p_dm, 0xd40, BIT(10));
							if (IQK_ready || (delay_count > 20))
								break;
							else {
								delay_ms(1);
						...
						if (delay_count < 20) {
							...
							TX_fail = odm_get_bb_reg(p_dm, 0xd40, BIT(12));

							if (~TX_fail) {
								odm_write_4byte(p_dm, 0xeb8, 0x02000000);
								VDF_X[k] = odm_get_bb_reg(p_dm, 0xd40, 0x07ff0000) << 21;
								odm_write_4byte(p_dm, 0xeb8, 0x04000000);
								VDF_Y[k] = odm_get_bb_reg(p_dm, 0xd40, 0x07ff0000) << 21;
								TX1IQKOK = true;
								break;
							} else {
								TX1IQKOK = false;
				...
				ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("TXB_VDF_cal_retry = %d\n", cal_retry));
				TX_X1[cal] = VDF_X[k - 1] ;
				TX_Y1[cal] = VDF_Y[k - 1];
			} else {
				/*============pathB TXIQK==============*/
				odm_write_4byte(p_dm, 0xe80, 0x18008c10);
				odm_write_4byte(p_dm, 0xe84, 0x38008c10);
				...
				while (1) {
					...
					if (delay_count < 20) {
						...
						if (~TX_fail) {
							odm_write_4byte(p_dm, 0xeb8, 0x02000000);
							TX_X1[cal] = odm_get_bb_reg(p_dm, 0xd40, 0x07ff0000) << 21;
							odm_write_4byte(p_dm, 0xeb8, 0x04000000);
							TX_Y1[cal] = odm_get_bb_reg(p_dm, 0xd40, 0x07ff0000) << 21;
							TX1IQKOK = true;
#if 0
			...
			/*======pathB VDF RX IQK ======*/
			if (VDF_enable == 1) {
				odm_set_bb_reg(p_dm, 0xee8, BIT(31), 0x0);/*TX VDF Disable*/
				ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("RXVDF Start\n"));
				...
				odm_write_4byte(p_dm, 0x984, 0x0046a911);
				odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);
				odm_write_4byte(p_dm, 0xe88, 0x02140119);
				odm_write_4byte(p_dm, 0xe8c, 0x28161420);
				...
				for (k = 0; k <= 2; k++) {
					...
					switch (k) {
					case 0:
						odm_write_4byte(p_dm, 0xe80, 0x38008c38);/*TX_Tone_idx[9:0], TxK_Mask[29] TX_Tone = 16*/
						odm_write_4byte(p_dm, 0xe84, 0x18008c38);/*RX_Tone_idx[9:0], RxK_Mask[29]*/
						odm_set_bb_reg(p_dm, 0xee8, BIT(30), 0x0);
						break;
					case 1:
						odm_write_4byte(p_dm, 0xe80, 0x28008c38);
						odm_write_4byte(p_dm, 0xe84, 0x08008c38);
						odm_set_bb_reg(p_dm, 0xee8, BIT(30), 0x0);
						break;
					case 2:
						ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("VDF_Y[1] = %x;;;VDF_Y[0] = %x\n", VDF_Y[1] >> 21 & 0x00007ff, VDF_Y[0] >> 21 & 0x00007ff));
						...
						rx_dt[cal] = ((16 * rx_dt[cal]) * 10000 / 13823);
						rx_dt[cal] = (rx_dt[cal] >> 1) + (rx_dt[cal] & BIT(0));
						odm_write_4byte(p_dm, 0xe80, 0x38008c20);
						odm_write_4byte(p_dm, 0xe84, 0x18008c20);
						odm_set_bb_reg(p_dm, 0xee8, 0x00003fff, rx_dt[cal] & 0x00003fff);
						break;
					default:
						break;
					}
					...
					if (k == 2)
						odm_set_bb_reg(p_dm, 0xee8, BIT(30), 0x1);  /*RX VDF Enable*/
					...
					while (1) {
						...
						odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
						ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("==== B VDF: path A RF0 = 0x%x ====\n",
							odm_get_rf_reg(p_dm, (enum rf_path)0, 0x0, RFREGOFFSETMASK)));
						ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("==== B VDF: path B RF0 = 0x%x ====\n",
							odm_get_rf_reg(p_dm, (enum rf_path)1, 0x0, RFREGOFFSETMASK)));
						odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);

						if (delay_count < 20) {
							/*============pathB VDF RXIQK Check==============*/
							RX_fail = odm_get_bb_reg(p_dm, 0xd40, BIT(11));
							if (RX_fail == 0) {
								...
								odm_set_bb_reg(p_dm, 0xe10, 0x000003ff, 0x200 >> 1);
								odm_set_bb_reg(p_dm, 0xe10, 0x03ff0000, 0x0 >> 1);
								RX1IQKOK = false;
								cal_retry++;
								if (cal_retry == 10)
									break;
				...
				ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("RXB_VDF_cal_retry = %d\n", cal_retry));
				RX_X1[cal] = VDF_X[k - 1] ;
				RX_Y1[cal] = VDF_Y[k - 1];
				odm_set_bb_reg(p_dm, 0xee8, BIT(31), 0x1);    /*TX VDF Enable*/
			} else {
				/*============pathB RXIQK==============*/
				odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
				odm_set_rf_reg(p_dm, (enum rf_path)path, 0xef, RFREGOFFSETMASK, 0x80000);
				...
				odm_set_bb_reg(p_dm, 0x978, 0x03FF8000, (TX_X1[cal]) >> 21 & 0x000007ff);
				odm_set_bb_reg(p_dm, 0x978, 0x000007FF, (TX_Y1[cal]) >> 21 & 0x000007ff);
				odm_set_bb_reg(p_dm, 0x978, BIT(31), 0x1);
				odm_set_bb_reg(p_dm, 0x97c, BIT(31), 0x0);
				odm_write_4byte(p_dm, 0x90c, 0x00008000);
				odm_write_4byte(p_dm, 0x984, 0x0046a911);
				...
				odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);
				odm_write_4byte(p_dm, 0xe80, 0x38008c15);
				odm_write_4byte(p_dm, 0xe84, 0x18008c15);
				odm_write_4byte(p_dm, 0xe88, 0x02140119);
				odm_write_4byte(p_dm, 0xe8c, 0x28161420);
				odm_write_4byte(p_dm, 0xeb8, 0x00100000);
				...
				while (1) {
					...
					odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
					ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("==== B: path A RF0 = 0x%x ====\n",
						odm_get_rf_reg(p_dm, (enum rf_path)0, 0x0, RFREGOFFSETMASK)));
					ODM_RT_TRACE(p_dm, ODM_COMP_CALIBRATION, ODM_DBG_LOUD, ("==== B: path B RF0 = 0x%x ====\n",
						odm_get_rf_reg(p_dm, (enum rf_path)1, 0x0, RFREGOFFSETMASK)));
					odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);
					...
					if (delay_count < 20) {
						...
						if (RX_fail == 0) {
							odm_write_4byte(p_dm, 0xeb8, 0x06000000);
							RX_X1[cal] = odm_get_bb_reg(p_dm, 0xd40, 0x07ff0000) << 21;
							odm_write_4byte(p_dm, 0xeb8, 0x08000000);
							RX_Y1[cal] = odm_get_bb_reg(p_dm, 0xd40, 0x07ff0000) << 21;
							RX1IQKOK = true;
							break;
						} else {
							odm_set_bb_reg(p_dm, 0xe10, 0x000003ff, 0x200 >> 1);
	...
	case RF_PATH_A:
		...
		if (tx_average == 0) {
			_iqk_tx_fill_iqc_8812a(p_dm, path, 0x200, 0x0);
			break;
		}
		...
		if (*p_dm->p_band_width == 2) {
			odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);
			odm_set_bb_reg(p_dm, 0xce8, 0x3fff0000, tx_dt[0] & 0x00003fff);
			odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
		}
		if (TX_finish == 1)
			_iqk_tx_fill_iqc_8812a(p_dm, path, TX_X, TX_Y);
		else
			_iqk_tx_fill_iqc_8812a(p_dm, path, 0x200, 0x0);

		if (rx_average == 0) {
			_iqk_rx_fill_iqc_8812a(p_dm, path, 0x200, 0x0);
			break;
		}
		...
		if (*p_dm->p_band_width == 2) {
			odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);
			odm_set_bb_reg(p_dm, 0xce8, 0x00003fff, rx_dt[0] & 0x00003fff);
			odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
		}

		if (RX_finish == 1)
			_iqk_rx_fill_iqc_8812a(p_dm, path, RX_X, RX_Y);
		else
			_iqk_rx_fill_iqc_8812a(p_dm, path, 0x200, 0x0);

		if (TX_finish && RX_finish) {
			p_rf_calibrate_info->is_need_iqk = false;
			p_rf_calibrate_info->iqk_matrix_reg_setting[chnl_idx].value[*p_dm->p_band_width][0] = ((TX_X & 0x000007ff) << 16) + (TX_Y & 0x000007ff);	/* path A TX */
			p_rf_calibrate_info->iqk_matrix_reg_setting[chnl_idx].value[*p_dm->p_band_width][1] = ((RX_X & 0x000007ff) << 16) + (RX_Y & 0x000007ff);	/* path A RX */

			if (*p_dm->p_band_width == 2) {
				odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);
				p_rf_calibrate_info->iqk_matrix_reg_setting[chnl_idx].value[*p_dm->p_band_width][4] = odm_read_4byte(p_dm, 0xce8);	/* path B VDF */
				odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
			}
		}
		break;
	case RF_PATH_B:
		...
		if (*p_dm->p_band_width == 2) {
			odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);
			odm_set_bb_reg(p_dm, 0xee8, 0x3fff0000, tx_dt[0] & 0x00003fff);
			odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
		}
		...
		if (*p_dm->p_band_width == 2) {
			odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);
			odm_set_bb_reg(p_dm, 0xee8, 0x00003fff, rx_dt[0] & 0x00003fff);
			odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
		}
		...
		if (TX_finish && RX_finish) {
			p_rf_calibrate_info->is_need_iqk = false;
			p_rf_calibrate_info->iqk_matrix_reg_setting[chnl_idx].value[*p_dm->p_band_width][2] = ((TX_X & 0x000007ff) << 16) + (TX_Y & 0x000007ff);	/* path B TX */
			p_rf_calibrate_info->iqk_matrix_reg_setting[chnl_idx].value[*p_dm->p_band_width][3] = ((RX_X & 0x000007ff) << 16) + (RX_Y & 0x000007ff);	/* path B RX */

			if (*p_dm->p_band_width == 2) {
				odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x1);
				p_rf_calibrate_info->iqk_matrix_reg_setting[chnl_idx].value[*p_dm->p_band_width][5] = odm_read_4byte(p_dm, 0xee8);	/* path B VDF */
				odm_set_bb_reg(p_dm, 0x82c, BIT(31), 0x0);
			}
		}
		break;
...
)
{
	...
	_iqk_tx_8812a(p_dm, RF_PATH_A, chnl_idx);
	_iqk_restore_rf_8812a(p_dm, RF_PATH_A, backup_rf_reg, RFA_backup, RF_REG_NUM);

	_iqk_tx_8812a(p_dm, RF_PATH_B, chnl_idx);
...
)
{
	if (is2T) {	/* 92C */
		if (is_main)
			odm_set_bb_reg(p_dm, REG_FPGA0_XB_RF_INTERFACE_OE, BIT(5) | BIT(6), 0x1);	/* 92C_Path_A */
		else
			odm_set_bb_reg(p_dm, REG_FPGA0_XB_RF_INTERFACE_OE, BIT(5) | BIT(6), 0x2);	/* BT */
	} else {		/* 88C */

		if (is_main)
			odm_set_bb_reg(p_dm, REG_FPGA0_XA_RF_INTERFACE_OE, BIT(8) | BIT(9), 0x2);	/* Main */
		else
			odm_set_bb_reg(p_dm, REG_FPGA0_XA_RF_INTERFACE_OE, BIT(8) | BIT(9), 0x1);	/* Aux */
	}
}
...
)
{
	...
	{
		/* For 88C 1T1R */
		_phy_set_rf_path_switch_8812a(p_dm, is_main, false);
	}
}
